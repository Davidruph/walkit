    ...
    <div class="card-box">
      <div class="col-md-12">
        ...
        ?>
          <div class="row mb-3">
            <div class="btn-group">
              <a class="btn btn-link btn-email" target="_blank" href="<?= $fileURL ?>?ref=<?= $url ?>"><?php echo $fileURL ?>?ref=<?= $url ?></a>
              <button type="button" class="btn btn-default btn-copy js-tooltip js-copy" data-toggle="tooltip" data-placement="bottom" data-copy="<?= $fileURL ?>?ref=<?= $url ?>" title="Copy to clipboard">
